...
print('# Download lahan kritis data')
...
zipfile.ZipFile("data/Sumatera.kml.zip").extract("Sumatera.kml", "./data/")
runner = CliRunner()
runner.invoke(kml2geojson.kml2geojson.main, ["data/Sumatera.kml", "./data"])

print('# Filter only singkep island lahan kritis data')
with open('data/Sumatera.geojson', 'r') as f:
    ...
    with open('data/singkep-lahan-kritis.geojson', 'w') as f:
        f.write(geojson.dumps(geojson_lahan_kritis, sort_keys=True))


print('# Clean unused file')
